...
## plot4.R is a script to read in the electrical power consumption data and
## create plot with four charts
...
## Create the four panels to which we will be plotting
par(mfrow = c(2,2), mar = c(5, 4, 2, 1))

## Create the time series plot of global active power data
with(power_data, plot(DateTime, Global_active_power, ylab = "Global Active Power (kilowatts)", type = "l", xlab=""))

## Create the time series plot of voltage data
with(power_data, plot(DateTime, Voltage, ylab = "Voltage", type = "l", xlab="datetime"))
...
## Create the time series plot of global reactive power
with(power_data, plot(DateTime, Global_reactive_power, ylab = "Global_reactive_power", type = "l", xlab="datetime"))
